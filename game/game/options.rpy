...
define config.name = _("Atenção aos Riscos")
...
define build.name = "RoteirodojogoAtenoaosRiscos"
...
define config.save_directory = "RoteirodojogoAtenoaosRiscos-1712769045"
